...
df = pd.read_csv("regressaoLinear/FuelConsumptionCo2.csv")
...
#Dividir o dataset em dados de treinamento e dados de teste neste casos vamos usar o train_test_split do scikitlearn
...
print('(A) Intercepto: ', modelo.intercept_) # intercepto é de onde a linha começa
print('(B) Inclinação: ', modelo.coef_)      # Inclinação da linha 
...
#Primeiro tem que fazer as predições usando o modelo e base de teste
...
# Mostrar as métricas
print("Soma dos Erros ao Quadrado (SSE): %.2f " % np.sum((predicoesCo2 - co2_teste)**2, axis=0))
